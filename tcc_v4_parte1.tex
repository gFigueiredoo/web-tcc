...
Além de uma implementação prática, o trabalho contribui metodologicamente ao propor uma forma sistematizada de calibração e validação para sistemas IoT domésticos, estabelecendo diretrizes que podem ser aplicadas em contextos similares. A abordagem centrada no usuário e a validação através de múltiplos cenários de teste proporcionam insights valiosos sobre fatores críticos para adoção de tecnologias de automação residencial.
...
\textbf{Quinta lacuna}: A validação experimental na literatura existente raramente considera cenários realísticos de uso doméstico, com muitos trabalhos limitando-se a testes de laboratório ou validações técnicas isoladas. Esta limitação resulta em soluções que podem funcionar tecnicamente mas falham em contextos práticos devido a fatores não considerados durante o desenvolvimento.
